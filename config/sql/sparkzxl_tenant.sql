...
-- ----------------------------
BEGIN;
INSERT INTO `tenant_info` VALUES (1362609400699944961, 1373086745500057600, 'hz', 'sparkzxl', 'https://oss.sparksys.top/halo/images-icon_1586839683912.jpg', '生活不止眼前的苟且，还有诗和远方', b'1', b'1', '2021-02-19 11:46:12', 1248084109452902400, '2021-03-20 16:45:48', 1373086745500057600);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tenant_manager` VALUES (1373086745500057600, 'admin', '$2a$10$v7mPmtnDyNLtXScdWa366uBEcIrtcSgHMqBYszQhMHefwWZIHA1O.', '管理员', 'admin@163.com', '18817280664', 'https://oss.sparksys.top/halo/images-icon_1586839683912.jpg', b'1', '2021-03-20 09:41:12', 0, '2021-03-19 21:50:54', 0, '2021-03-19 21:50:56');
COMMIT;
