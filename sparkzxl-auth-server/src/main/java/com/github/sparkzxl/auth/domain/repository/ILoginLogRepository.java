...
public interface ILoginLogRepository {
     ...
     * @param pageNum     当前页
     * @param pageSize    分页大小
     * @param realmStatus 领域管理员
     * @param realmUserId 领域管理员账号
     * @param account     账户
     * @param startTime   开始时间
     * @param endTime     结束时间
     * @return PageInfo<LoginLog>
     */
    PageInfo<LoginLog> getLoginLogPage(int pageNum, int pageSize, boolean realmStatus, Long realmUserId, String account, Date startTime, Date endTime);
